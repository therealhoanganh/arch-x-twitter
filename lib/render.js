...
const DEFAULT_POST_ORDER = ['dl-ed', 'url', 'x-author', 'x-name', 'x-post-id', 'published', 'x-profile', 'media', 'likes', 'reposts', 'replies', 'tags'];
const DEFAULT_PROFILE_ORDER = ['url', 'x-author', 'x-name', 'followers', 'posts', 'joined', 'count', 'x-synced', 'tags'];
